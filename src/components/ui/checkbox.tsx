...
function Checkbox({
  ...
  return (
    ...
    >
      ...
      >
        {/* Indeterminate (some rows selected) shows a dash, so the state never depends on color alone. */}
